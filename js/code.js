...
// aca comienzan los datos del CHARTJS
...
$(".opcionesMeses").click(function () {
    $(this)
        .addClass(($(this).val() === "selected ")? '' : ' selected '  )
        .siblings("div").removeClass("selected");
});

$(".opcion").click(function () {
    $(this)
        .addClass(($(this).val() === "Seleccionada ")? '' : ' Seleccionada '  )
        .siblings("div").removeClass("Seleccionada");
